(() => {
  // ===== CONFIG =====
  const LEAD_ENDPOINT = 'https://lead-relay.leestygpt.workers.dev/lead/5PNZTERG43';
  ...
  const targets = document.querySelectorAll(
    '.adv, .service, .step, .review, .member, .contact-card, .faq__item, .form, .hero__card, .trust__inner'
  );
